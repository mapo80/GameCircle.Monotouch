...
//    // A reference to the GameCircle profile is kept, if available.
//    AGSProfile profile = null;
//    
...
//        // This means that the local player's profile should be available as early as possible.
//        callback += (successStatus) => {
//            if(successStatus) {  
//                // On a successful initialization of the GameCircle through
//                // the Unity Social API, immediately begin the process
//                // of retrieving the local player profile.
//                AGSProfilesClient.PlayerAliasReceivedEvent += (playerProfile) => {
